...
# Triángulos en la parte superior
rt.scene.append(Triangle(v0=[-1.5, 0.7, -5], v1=[-1.0, 1.7, -5], v2=[-0.5, 0.7, -5], material=space))
rt.scene.append(Triangle(v0=[-0.5, 0.7, -5], v1=[0.0, 1.7, -5], v2=[0.5, 0.7, -5], material=RED))
rt.scene.append(Triangle(v0=[0.5, 0.7, -5], v1=[1.0, 1.7, -5], v2=[1.5, 0.7, -5], material=yellowGlass))

# Cilindros en la parte inferior
rt.scene.append(Cylinder(position=[-1.3, -0.7, -5], radius=0.6, height=1.2, material=marble))
rt.scene.append(Cylinder(position=[0, -0.7, -5], radius=0.6, height=1.2, material=diamondReflective))
rt.scene.append(Cylinder(position=[1.3, -0.7, -5], radius=0.6, height=1.2, material=bluega))
